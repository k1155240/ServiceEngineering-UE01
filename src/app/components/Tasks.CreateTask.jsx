	...
	render(){
		 return (
            ...
            <div className="form-group row">
                ...
                <input type="text" className="form-control" id="Task3" placeholder="MM-DD-JJJJ"/>
            </div>
            <div className="form-group row">
                <label htmlFor="Task4">End date</label>
                <input type="text" className="form-control" id="Task4" name="Task4" placeholder="MM-DD-JJJ"/>
            </div>
            <div className="form-group row">
